#!/usr/bin/env python3
"""
Script Python para testar OAuth do AliExpress de forma simplificada
"""
...
class AliExpressSimpleOAuth:
    ...
    def test_different_auth_urls(self):
        """Testar diferentes URLs de autorização"""
        print("🧪 Testando diferentes URLs de autorização...\n")
        
        # Teste 1: URL mais simples
        params1 = {
            'response_type': 'code',
        ...
        print("🧪 Teste estas URLs uma por vez para ver qual funciona.")
        print("Se alguma funcionar, copie o código e execute:")
        print("python test_oauth_simple.py SEU_CODIGO")
    ...
    def test_product_api(self, access_token):
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if access_token:
            oauth.test_product_api(access_token)
    else:
        oauth.test_different_auth_urls()
